...
def _read(path: Union[str, Path]) -> Image.Image:
...
def _cache_key(prompt: str, init_image: Union[str, Path], mask_image: Union[str, Path], **extra) -> str:
    payload = {
        "prompt": prompt,
